...
import { MEMBERS, SCORING_RULES } from "@/lib/tournament-data";
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          border: 0,
          padding: 2,
          background: value ? "var(--signal)" : "rgba(255,255,255,0.1)",
          position: "relative",
      ...
      <div className="scroll">
        <div style={{ padding: "12px 20px 0" }}>
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(0,210,106,0.10), transparent 70%)",
            }}
          >
            <div className="t-eyebrow">LIGA</div>
            <div className="t-h2" style={{ fontSize: 32, marginTop: 4 }}>
              AMIGOS DEL BAR
            </div>
            <div className="t-meta" style={{ marginTop: 6 }}>
              12 MIEMBROS · CREADA 11 MAY · POR @TANIA
            </div>
            <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
              <button
                className="btn btn-primary"
                style={{ flex: 1, padding: "12px 14px", fontSize: 12 }}
              >
                COMPARTIR · POLLA-FB7K
              </button>
              <button
                className="btn btn-ghost"
                style={{ padding: "12px 14px", fontSize: 12 }}
              >
                <GameIcon name="share" size={14} />
              </button>
            </div>
          </div>
        </div>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                background:
                  tab === t.id ? "var(--fg)" : "rgba(255,255,255,0.03)",
          ...
          <div style={{ paddingTop: 16 }}>
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ padding: "0 20px" }}>
                <div className="card t-body">
                  Liga creada para seguir el Mundial 2026 con los amigos del bar
                  de los miércoles. Predice todos los partidos de fase de grupos
                  y completa tu Bracket Oracle antes del 11 de junio para sumar
                  puntos extras.
                </div>
              </div>
            </div>
                ...
                <div className="kpi">
                  <div>
                    ...
                    <span className="value">
                      28<span className="small">/104</span>
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    <span className="label">PROM PTS</span>
              ...
              >
                {[
                  ...
                  [
                    "Diferencia de gol",
                    `+${R.diff}`,
                    "Mismo ganador, mismo margen",
                  ],
                  [
                    "Solo ganador / empate",
                    `+${R.winner}`,
                    "Acierta el resultado",
                  ],
                  [
                    "Bonus por racha",
                    "+1×N",
                    "+1 pt por nivel de racha (máx +5)",
                  ],
                  ...
                  >
                    <div
                      style={{
                        ...
                        padding: "6px 10px",
                        textAlign: "center",
                        background: v.startsWith(`+${R.oracleChampion}`)
                          ? "var(--warn)"
                          : v.startsWith(`+${R.combo}`)
                            ? "var(--signal)"
                            : "rgba(255,255,255,0.05)",
                        color: v.startsWith(`+${R.oracleChampion}`)
                          ? "#1A1400"
                          : v.startsWith(`+${R.combo}`)
                            ? "#04130A"
                            : "var(--fg)",
              ...
              >
                ...
                >
                  ...
                  >
                    <div>
                      <div className="t-h3" style={{ fontSize: 14 }}>
                        Cierra {closeBeforeKickoff} min antes
                      </div>
                      <div
                        className="t-meta"
                        style={{
                      ...
                      >
                        Tiempo de gracia antes del kickoff
                      </div>
                    </div>
                    <div
                      className="t-num"
                      style={{ fontSize: 28, color: "var(--signal)" }}
                    >
                      {closeBeforeKickoff}&apos;
                    </div>
                  </div>
                  <input
                    ...
                    max="60"
                    step="5"
                    value={closeBeforeKickoff}
                    onChange={(e) => setCloseBeforeKickoff(+e.target.value)}
                    style={{ width: "100%", accentColor: "var(--signal)" }}
                  />
                </div>
                <Toggle
                  label="Modo estricto"
                  desc="Sin ediciones después del kickoff"
                  value={strict}
                  onChange={setStrict}
                />
                <Toggle
                  label="Bonus combo"
                  desc="+10 al acertar 5/5 una jornada"
                  value={bonusCombo}
                  onChange={setBonusCombo}
                />
              </div>
            </div>
          </div>
